...
# NEW: Extract State from config.json
...
# Convert State to S3-friendly folder name (replace spaces with underscores)
...
echo "[INFO] S3 Folder: $DEVICE_STATE_FOLDER"
...
# UPDATED: Path structure is now bucket/State/DeviceID/
