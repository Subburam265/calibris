...
EOF
  ...
  # Display SAFE MODE and Firmware Tampered on LCD
  # Replace these commands with your actual LCD command-line utilities if different
  lcd_clear
  lcd_set_cursor 0 0
  lcd_send_string "SAFE MODE"
  lcd_set_cursor 1 0
  lcd_send_string "Firmware Tampered"

  # The warning will remain until the LCD is cleared by another process (i.e., after measure_weight.service is started manually)
fi
