            ...
            case STATE_COOLDOWN:
                if (value == 0) {
                    ...
                    if (elapsed >= COOLDOWN_SECONDS) {
                        ...
                        system("touch /home/pico/tamper.lock"); 
    
    // Step 2: Send a warning to all logged-in terminals
    system("wall 'CRITICAL SECURITY ALERT: Tamper detected! System is locked.'");
                        goto exit_program;
                    } else {
